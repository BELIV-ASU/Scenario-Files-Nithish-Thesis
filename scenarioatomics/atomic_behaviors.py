...
class StopVehicle(AtomicBehavior):
    ...
    def update(self):
        ...
        #print('brake value of', self._actor, self._control.brake)
...
class CustomWait(AtomicBehavior):
    ...
    def __init__(self, name="CustomWait", wait_time=0.01, actor_name=None):
        """
        Setup actor
        """
        super().__init__(name)
    ...
    def update(self): 
        ...
        if self.i==0:
            ...
            print("Start time of ", self.actor_name, time.time())
        self.i = self.i + 1
